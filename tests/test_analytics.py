...
def test_analytics_builds_every_required_summary_and_seasonality_table():
    data = payload([
        ...
        {"id": "3", "date": "2026-05-01", "category": "overtime", "direction": "worked", "hours": 3, "status": "reconciled"},
    ])
    data["pay_periods"] = [
...
def test_comp_lifecycle_reconciles_and_uses_matured_lots_only():
    data = payload([
        {"id": "earned", "date": "2026-01-01", "category": "comp", "direction": "earned", "hours": 10,
         "status": "reconciled", "expiration_date": "2026-06-30"},
        {"id": "used-before", "date": "2026-03-02", "category": "comp", "direction": "used", "hours": 4,
         "status": "reconciled", "earned_transaction_id": "earned"},
        {"id": "paid", "date": "2026-06-30", "category": "comp", "direction": "paid_out", "hours": 4,
         "status": "planned", "earned_transaction_id": "earned"},
        {"id": "used-after", "date": "2026-07-01", "category": "comp", "direction": "used", "hours": 2,
         "status": "planned", "earned_transaction_id": "earned"},
    ])
...
def test_denied_and_disposition_transactions_are_not_absence_hours():
    result = analyze_leave_year(payload([
        {"id": "1", "date": "2026-02-01", "category": "annual", "direction": "used", "hours": 8, "status": "denied"},
        {"id": "2", "date": "2026-02-02", "category": "comp", "direction": "paid_out", "hours": 6, "status": "planned"},
